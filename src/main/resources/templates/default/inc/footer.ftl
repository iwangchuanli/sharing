        ...
        <div class="footer-row">
            <nav class="footer-nav">
                <a class="footer-nav-item footer-nav-logo" href="${base}/">
                    <img src="<@resource src=options['site_logo']/>" alt="Sharing"/>
                </a>
            ...
            <div class="gh-foot-min-back hidden-xs hidden-sm">
                <!-- 请保留此处标识-->
                <#--<span class="footer-nav-item">Powered by <a href="https://github.com/wangcl/Sharing" target="_blank">Sharing</a></span>-->
