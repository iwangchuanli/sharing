    ...
    <@contents channelId=topId size=8>
        <#list results.content as row>
            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12">
                <div class="block">
                    <a class="block-thumbnail" href="${base}/post/${row.id}.html">
            ...
            <ul class="list-group row topic-list">
                <#list results.content as row>
                    <li class="list-group-item media col-md-6" style="margin-top: 0px;">
                        <a class="reply_last_time hidden-xs meta" href="${base}/post/${row.id}.html">
                        ...
                        <div class="infos">
                            <div class="media-heading">
                                <@utils.showChannel row/><a href="${base}/post/${row.id}.html">${row.title?html}</a>
                            </div>
                        </div>
                    </li>
                </#list>
